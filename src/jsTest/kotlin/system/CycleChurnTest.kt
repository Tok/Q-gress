...
/**
 * Tests for [Cycle.churnChances] — the pure density-churn math extracted from `managePortalDensity` (PLAN
...
class CycleChurnTest {
    ...
    fun discoveryDominatesOnAnEmptyBoard() {
        val c = Cycle.churnChances(count = 0, target = target, rate = rate, hasSpace = true)
    ...
    fun creationAndRemovalCrossAtTheTarget() {
        val c = Cycle.churnChances(count = target, target = target, rate = rate, hasSpace = true)
    ...
    fun removalDominatesAboveTheTarget() {
        val c = Cycle.churnChances(count = 2 * target, target = target, rate = rate, hasSpace = true)
    ...
    fun bothChancesAreClampedFarAboveTheTarget() {
        val c = Cycle.churnChances(count = 100, target = target, rate = rate, hasSpace = true)
    ...
    fun withNoSpaceTheDiscoveryBudgetRollsIntoRemoval() {
        ...
        val open = Cycle.churnChances(count = 0, target = target, rate = rate, hasSpace = true)
        val packed = Cycle.churnChances(count = 0, target = target, rate = rate, hasSpace = false)
