...
/**
 * Tests for [NonFaction.opposingHalf] — the pure directional pick extracted from
...
class NonFactionTest {
    ...
    fun picksTheHalfOpposingTheNpcsBearing() {
        ...
        val half = NonFaction.opposingHalf(all, from = east, cx = 0.0, cy = 0.0, nearCentre = 10.0)
    ...
    fun nearTheCentreEveryDirectionIsFairGame() {
        ...
        val half = NonFaction.opposingHalf(all, from = Pos(1, 0), cx = 0.0, cy = 0.0, nearCentre = 10.0)
