...
fun Ctx.clearRect(rect: Line) = this.clearRect(rect.fromX, rect.fromY, rect.w, rect.h)

fun Ctx.drawImage(image: Canvas, x: Int, y: Int) = this.drawImage(image, x.toDouble(), y.toDouble())
