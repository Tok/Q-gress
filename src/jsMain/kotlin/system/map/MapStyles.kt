...
object MapStyles {
    ...
    // Footpaths are drawn a bit wider than life (~2-3 grid cells at z18): a real ~2 m path is ~1 cell, which
    // the 3-cell cost-blur would otherwise average into grey before it registers a walkable corridor.
    val SHADOW_STYLE = """{
        "version": 8,
        "sources": {
            "openmaptiles": { "type": "vector", "url": "$OPENMAPTILES_URL", "generateId": true }
        ...
        "layers": [
            ...
            },
            {
                ...
                "paint": {
                    "line-color": "#ffffff",
                    "line-width": ["interpolate", ["linear"], ["zoom"], 14, 8, 18, 24]
                }
            }
        ]
    }"""
