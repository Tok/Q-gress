...
object Icons {
    ...
    /** Speaker with an ✕ where the sound waves were — the muted Volume state. */
    const val VOLUME_MUTED =
        "<svg viewBox=\"0 0 16 16\" width=\"16\" height=\"16\" fill=\"currentColor\" aria-hidden=\"true\">" +
            "<path d=\"M3 6h2.5L9 3v10L5.5 10H3z\"/>" +
            "<path d=\"M11 6l4 4M15 6l-4 4\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.3\" stroke-linecap=\"round\"/>" +
            "</svg>"
